...
ajax.formats.get_default_format = (function ajax$formats$get_default_format(response,p__38454){
...
var request = map__38455__$1;
var response_format = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38455__$1,new cljs.core.Keyword(null,"response-format","response-format",1664465322));
...
var fexpr__38460 = new cljs.core.Keyword(null,"read","read",1140058661).cljs$core$IFn$_invoke$arity$1(format);
return (fexpr__38460.cljs$core$IFn$_invoke$arity$1 ? fexpr__38460.cljs$core$IFn$_invoke$arity$1(response) : fexpr__38460.call(null,response));
});

ajax.formats.detect_response_format_read.cljs$core$IFn$_invoke$arity$1 = (function (request){
return (function (response){
var format = ajax.formats.get_default_format(response,request);
var fexpr__38461 = new cljs.core.Keyword(null,"read","read",1140058661).cljs$core$IFn$_invoke$arity$1(format);
return (fexpr__38461.cljs$core$IFn$_invoke$arity$1 ? fexpr__38461.cljs$core$IFn$_invoke$arity$1(response) : fexpr__38461.call(null,response));
});
});

ajax.formats.detect_response_format_read.cljs$lang$maxFixedArity = 2;

ajax.formats.accept_header = (function ajax$formats$accept_header(p__38462){
var map__38463 = p__38462;
var map__38463__$1 = (((((!((map__38463 == null))))?(((((map__38463.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__38463.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__38463):map__38463);
var request = map__38463__$1;
var response_format = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38463__$1,new cljs.core.Keyword(null,"response-format","response-format",1664465322));
