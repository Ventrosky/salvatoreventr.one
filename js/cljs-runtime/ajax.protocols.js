...
ajax.protocols.Response.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__4387__auto__,k37623,else__4388__auto__){
var self__ = this;
...
return (function (ret__4407__auto__,p__37630){
var vec__37631 = p__37630;
var k__4408__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37631,(0),null);
var v__4409__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37631,(1),null);
...
ajax.protocols.Response.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__37622){
var self__ = this;
var G__37622__$1 = this;
return (new cljs.core.RecordIter((0),G__37622__$1,5,new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"status","status",-1997798413),new cljs.core.Keyword(null,"body","body",-2049205669),new cljs.core.Keyword(null,"status-text","status-text",-1834235478),new cljs.core.Keyword(null,"headers","headers",-835030129),new cljs.core.Keyword(null,"was-aborted","was-aborted",-2120084828)], null),(cljs.core.truth_(self__.__extmap)?cljs.core._iterator(self__.__extmap):cljs.core.nil_iter())));
});
...
var h__4243__auto____$1 = (function (){var fexpr__37650 = ((function (h__4243__auto__,this__4381__auto____$1){
return (function (coll__4382__auto__){
return (-473222333 ^ cljs.core.hash_unordered_coll(coll__4382__auto__));
});})(h__4243__auto__,this__4381__auto____$1))
;
return fexpr__37650(this__4381__auto____$1);
})();
...
ajax.protocols.Response.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this37624,other37625){
var self__ = this;
var this37624__$1 = this;
return (((!((other37625 == null)))) && ((this37624__$1.constructor === other37625.constructor)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this37624__$1.status,other37625.status)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this37624__$1.body,other37625.body)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this37624__$1.status_text,other37625.status_text)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this37624__$1.headers,other37625.headers)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this37624__$1.was_aborted,other37625.was_aborted)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this37624__$1.__extmap,other37625.__extmap)));
});
...
ajax.protocols.Response.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__4392__auto__,k__4393__auto__,G__37622){
var self__ = this;
var this__4392__auto____$1 = this;
var pred__37663 = cljs.core.keyword_identical_QMARK_;
var expr__37664 = k__4393__auto__;
if(cljs.core.truth_((function (){var G__37666 = new cljs.core.Keyword(null,"status","status",-1997798413);
var G__37667 = expr__37664;
return (pred__37663.cljs$core$IFn$_invoke$arity$2 ? pred__37663.cljs$core$IFn$_invoke$arity$2(G__37666,G__37667) : pred__37663.call(null,G__37666,G__37667));
})())){
return (new ajax.protocols.Response(G__37622,self__.body,self__.status_text,self__.headers,self__.was_aborted,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((function (){var G__37668 = new cljs.core.Keyword(null,"body","body",-2049205669);
var G__37669 = expr__37664;
return (pred__37663.cljs$core$IFn$_invoke$arity$2 ? pred__37663.cljs$core$IFn$_invoke$arity$2(G__37668,G__37669) : pred__37663.call(null,G__37668,G__37669));
})())){
return (new ajax.protocols.Response(self__.status,G__37622,self__.status_text,self__.headers,self__.was_aborted,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((function (){var G__37670 = new cljs.core.Keyword(null,"status-text","status-text",-1834235478);
var G__37671 = expr__37664;
return (pred__37663.cljs$core$IFn$_invoke$arity$2 ? pred__37663.cljs$core$IFn$_invoke$arity$2(G__37670,G__37671) : pred__37663.call(null,G__37670,G__37671));
})())){
return (new ajax.protocols.Response(self__.status,self__.body,G__37622,self__.headers,self__.was_aborted,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((function (){var G__37672 = new cljs.core.Keyword(null,"headers","headers",-835030129);
var G__37673 = expr__37664;
return (pred__37663.cljs$core$IFn$_invoke$arity$2 ? pred__37663.cljs$core$IFn$_invoke$arity$2(G__37672,G__37673) : pred__37663.call(null,G__37672,G__37673));
})())){
return (new ajax.protocols.Response(self__.status,self__.body,self__.status_text,G__37622,self__.was_aborted,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((function (){var G__37674 = new cljs.core.Keyword(null,"was-aborted","was-aborted",-2120084828);
var G__37675 = expr__37664;
return (pred__37663.cljs$core$IFn$_invoke$arity$2 ? pred__37663.cljs$core$IFn$_invoke$arity$2(G__37674,G__37675) : pred__37663.call(null,G__37674,G__37675));
})())){
return (new ajax.protocols.Response(self__.status,self__.body,self__.status_text,self__.headers,G__37622,self__.__meta,self__.__extmap,null));
} else {
return (new ajax.protocols.Response(self__.status,self__.body,self__.status_text,self__.headers,self__.was_aborted,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__4393__auto__,G__37622),null));
}
}
}
}
...
ajax.protocols.Response.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__4384__auto__,G__37622){
var self__ = this;
var this__4384__auto____$1 = this;
return (new ajax.protocols.Response(self__.status,self__.body,self__.status_text,self__.headers,self__.was_aborted,G__37622,self__.__extmap,self__.__hash));
});
 ...
 */
ajax.protocols.map__GT_Response = (function ajax$protocols$map__GT_Response(G__37626){
var extmap__4424__auto__ = (function (){var G__37690 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$variadic(G__37626,new cljs.core.Keyword(null,"status","status",-1997798413),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"body","body",-2049205669),new cljs.core.Keyword(null,"status-text","status-text",-1834235478),new cljs.core.Keyword(null,"headers","headers",-835030129),new cljs.core.Keyword(null,"was-aborted","was-aborted",-2120084828)], 0));
...
return (new ajax.protocols.Response(new cljs.core.Keyword(null,"status","status",-1997798413).cljs$core$IFn$_invoke$arity$1(G__37626),new cljs.core.Keyword(null,"body","body",-2049205669).cljs$core$IFn$_invoke$arity$1(G__37626),new cljs.core.Keyword(null,"status-text","status-text",-1834235478).cljs$core$IFn$_invoke$arity$1(G__37626),new cljs.core.Keyword(null,"headers","headers",-835030129).cljs$core$IFn$_invoke$arity$1(G__37626),new cljs.core.Keyword(null,"was-aborted","was-aborted",-2120084828).cljs$core$IFn$_invoke$arity$1(G__37626),null,cljs.core.not_empty(extmap__4424__auto__),null));
});
