...
var G__27444 = devtools.prefs.pref(v);
v = G__27444;
continue;
} else {
return v;
...
}catch (e27391){var _e__26284__auto__ = e27391;
return false;
}})();
...
}catch (e27406){var _e__26284__auto__ = e27406;
return false;
}})();
...
}catch (e27408){var _e__26284__auto__ = e27408;
return false;
}}
}
});
...
var vec__27419 = devtools.munging.parse_constructor_info(constructor_fn);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27419,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27419,(1),null);
...
return cljs.core.some((function (p1__27423_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(devtools.formatters.helpers.pref(new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__27423_SHARP_);
}),template);
});
