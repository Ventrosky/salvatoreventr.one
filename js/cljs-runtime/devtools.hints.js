...
var G__27212 = cljs.core.PersistentArrayMap.EMPTY;
var G__27213 = native_stack_trace;
var G__27214 = new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"ua-product","ua-product",938384227),new cljs.core.Keyword(null,"chrome","chrome",1718738387)], null);
var G__27215 = new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"asset-root","asset-root",1771735072),""], null);
return (cljs.stacktrace.parse_stacktrace.cljs$core$IFn$_invoke$arity$4 ? cljs.stacktrace.parse_stacktrace.cljs$core$IFn$_invoke$arity$4(G__27212,G__27213,G__27214,G__27215) : cljs.stacktrace.parse_stacktrace.call(null,G__27212,G__27213,G__27214,G__27215));
});
...
var file = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27219__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27219__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27219__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return devtools.hints.make_sense_of_the_error(error.message,file,line,column);
}catch (e27217){var _e = e27217;
return false;
}});
devtools.hints.type_error_to_string = (function devtools$hints$type_error_to_string(self){
var temp__5718__auto___27295 = devtools.hints.get_processed_errors_BANG_();
if(cljs.core.truth_(temp__5718__auto___27295)){
var seen_errors_27296 = temp__5718__auto___27295;
if(cljs.core.truth_(seen_errors_27296.has(self))){
} else {
seen_errors_27296.add(self);

var temp__5720__auto___27297 = devtools.hints.error_object_sense(self);
if(cljs.core.truth_(temp__5720__auto___27297)){
var sense_27298 = temp__5720__auto___27297;
self.message = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(self.message),", a sanity hint:\n",cljs.core.str.cljs$core$IFn$_invoke$arity$1(sense_27298)].join('');
} else {
}
}
} else {
