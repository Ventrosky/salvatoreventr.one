...
var o27096 = temp__5718__auto__;
var temp__5718__auto____$1 = (o27096["core"]);
if(cljs.core.truth_(temp__5718__auto____$1)){
var o27097 = temp__5718__auto____$1;
return (o27097["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__26232__auto__ = f;
return (o__26232__auto__["toString"]).call(o__26232__auto__);
} else {
return "";
}
}catch (e27100){var _ = e27100;
return "";
}});
...
try{var o__26232__auto___27386 = t;
(o__26232__auto___27386["cljs$lang$ctorPrWriter"]).call(o__26232__auto___27386,t,writer);
}catch (e27115){var __27387 = e27115;
}
...
var char_code = (function (){var o__26232__auto__ = (new String(char$));
return (o__26232__auto__["charCodeAt"]).call(o__26232__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__26232__auto__ = String;
return (o__26232__auto__["fromCharCode"]).call(o__26232__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__27131 = num_code;
switch (G__27131) {
case (1):
return (185);
...
var o__26232__auto__ = String;
return (o__26232__auto__["fromCharCode"]).call(o__26232__auto__,superscript_code);
});
/**
...
}catch (e27151){var _e__26284__auto__ = e27151;
return false;
}})())){
...
var vec__27153 = devtools.munging.parse_fn_source(fn_source);
var name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27153,(0),null);
...
if(cljs.core.truth_(temp__5718__auto__)){
var o27186 = temp__5718__auto__;
var temp__5718__auto____$1 = (o27186["dependencies_"]);
if(cljs.core.truth_(temp__5718__auto____$1)){
var o27187 = temp__5718__auto____$1;
return (o27187["nameToPath"]);
} else {
return null;
}
} else {
...
var i__4731__auto___27414 = (0);
while(true){
if((i__4731__auto___27414 < len__4730__auto___27413)){
args__4736__auto__.push((arguments[i__4731__auto___27414]));

var G__27418 = (i__4731__auto___27414 + (1));
i__4731__auto___27414 = G__27418;
continue;
} else {
}
break;
...
var G__27425 = cljs.core.concat.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last(remaining_tokens)], null),name_tokens);
var G__27426 = cljs.core.butlast(remaining_tokens);
name_tokens = G__27425;
remaining_tokens = G__27426;
continue;
}
}
break;
...
/** @this {Function} */
devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq27189){
var G__27190 = cljs.core.first(seq27189);
var seq27189__$1 = cljs.core.next(seq27189);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__27190,seq27189__$1);
});
...
var vec__27203 = cljs.core.split_with((function (p1__27202_SHARP_){
return cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(p1__27202_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27203,(0),null);
var arity_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27203,(1),null);
...
var vec__27209 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(remaining_tokens,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([detector], 0));
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27209,(0),null);
var name_and_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27209,(1),null);
if(cljs.core.empty_QMARK_(protocol_ns)){
var G__27428 = cljs.core.rest(remaining_tokens);
var G__27429 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(name_tokens,cljs.core.first(remaining_tokens));
remaining_tokens = G__27428;
name_tokens = G__27429;
continue;
} else {
...
var vec__27225 = devtools.munging.strip_arity(tokens);
var tokens__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27225,(0),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27225,(1),null);
var vec__27228 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(tokens__$1,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([effective_detector], 0));
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27228,(0),null);
var tokens__$2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27228,(1),null);
var vec__27231 = devtools.munging.parse_protocol(tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27231,(0),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27231,(1),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27231,(2),null);
var protocol_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27231,(3),null);
...
var vec__27239 = result;
var munged_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27239,(0),null);
var munged_name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27239,(1),null);
var munged_protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27239,(2),null);
var munged_protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27239,(3),null);
var munged_protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27239,(4),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27239,(5),null);
...
if(cljs.core.truth_(temp__5718__auto__)){
var vec__27242 = temp__5718__auto__;
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27242,(0),null);
var args = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27242,(1),null);
var vec__27245 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$1(munged_name);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27245,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27245,(1),null);
...
return cljs.core.concat.cljs$core$IFn$_invoke$arity$2(cljs.core.take.cljs$core$IFn$_invoke$arity$2((2),fn_info),cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),(function (){var G__27255 = cljs.core.second(cljs.core.first(arities));
return (devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1 ? devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1(G__27255) : devtools.munging.parse_fn_info_deep.call(null,G__27255));
})()));
}
} else {
return fn_info;
...
var G__27452 = (arity + (1));
var G__27453 = (function (){var temp__5718__auto__ = devtools.munging.get_fn_fixed_arity(f,arity);
if(cljs.core.truth_(temp__5718__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__27273){
var vec__27274 = p__27273;
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27274,(0),null);
var arity_fn = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27274,(1),null);
...
return cljs.core.get.cljs$core$IFn$_invoke$arity$2(arities,p1__27287_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),p1__27288_SHARP_);
...
args__4736__auto__.push((arguments[i__4731__auto___27461]));
...
devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__27291){
var vec__27292 = p__27291;
var humanize_QMARK_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27292,(0),null);
...
/** @this {Function} */
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq27289){
var G__27290 = cljs.core.first(seq27289);
var seq27289__$1 = cljs.core.next(seq27289);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__27290,seq27289__$1);
});
...
var include_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27323__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27323__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27323__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27323__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__27324 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$2(munged_name,ns_detector);
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27324,(0),null);
var fn_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27324,(1),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27324,(2),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27324,(3),null);
var protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27324,(4),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27324,(5),null);
...
var o__26232__auto__ = f;
return (o__26232__auto__["getBasis"]).call(o__26232__auto__);
});
/**
...
}catch (e27344){var _e__26284__auto__ = e27344;
...
var G__27474 = (obj[cljs.core.first(path)]);
var G__27475 = cljs.core.rest(path);
obj = G__27474;
path = G__27475;
continue;
} else {
...
return (function (accum,p__27358){
var vec__27362 = p__27358;
var bit = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27362,(0),null);
var protocol = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27362,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__27365){
var vec__27366 = p__27365;
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27366,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27366,(1),null);
var selector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27366,(2),null);
...
var sorted_fns = cljs.core.map.cljs$core$IFn$_invoke$arity$2(((function (name,sorted_matches,vec__27381,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__27370_SHARP_){
return (obj[cljs.core.first(p1__27370_SHARP_)]);
});})(name,sorted_matches,vec__27381,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);
