...
var G__36929 = o;
(G__36929[reagent.impl.template.cached_prop_name(k)] = (reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
return (function() { 
var G__37150__delegate = function (args){
...
var G__36969 = o;
(G__36969[reagent.impl.template.cached_custom_prop_name(k)] = reagent.impl.template.convert_prop_value(v));
...
if(cljs.core.ifn_QMARK_(x)){
return (function() { 
var G__37158__delegate = function (args){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(x,args);
};
...
while (G__37159__i < G__37159__a.length) {G__37159__a[G__37159__i] = arguments[G__37159__i + 0]; ++G__37159__i;}
  args = new cljs.core.IndexedSeq(G__37159__a,0,null);
} 
return G__37158__delegate.call(this,args);};
G__37158.cljs$lang$maxFixedArity = 0;
G__37158.cljs$lang$applyTo = (function (arglist__37160){
var args = cljs.core.seq(arglist__37160);
return G__37158__delegate(args);
});
...
var G__37007 = props;
var G__37007__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__37007,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__37007);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__37007__$1,new cljs.core.Keyword(null,"class","class",-2030961996),(function (){var old_class = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
if((old_class == null)){
return class$;
} else {
...
reagent.impl.template.stringify_class = (function reagent$impl$template$stringify_class(p__37008){
...
var props = map__37009__$1;
var class$ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37009__$1,new cljs.core.Keyword(null,"class","class",-2030961996));
...
reagent.impl.template.input_node_set_value = (function reagent$impl$template$input_node_set_value(node,rendered_value,dom_value,component,p__37037){
...
var on_write = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37038__$1,new cljs.core.Keyword(null,"on-write","on-write",31519475));
...
return reagent.impl.batching.do_after_render(((function (node_value,map__37038,map__37038__$1,on_write){
return (function (){
...
});})(node_value,map__37038,map__37038__$1,on_write))
);
} else {
...
var G__37101 = jsprops;
(G__37101["defaultValue"] = value);

(G__37101["onChange"] = ((function (G__37101,v,value,on_change){
return (function (p1__37078_SHARP_){
return reagent.impl.template.input_handle_change(this$,on_change,p1__37078_SHARP_);
});})(G__37101,v,value,on_change))
);
...
var vec__37111 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37111,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37111,(1),null);
var class$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37111,(2),null);
...
var jsprops = ({"argv": v});
var temp__5724__auto___37231 = reagent.impl.template.key_from_vec(v);
if((temp__5724__auto___37231 == null)){
} else {
var key_37232 = temp__5724__auto___37231;
(jsprops["key"] = key_37232);
}
...
var temp__5724__auto___37239 = reagent.impl.template.key_from_vec(argv);
if((temp__5724__auto___37239 == null)){
} else {
var key_37241 = temp__5724__auto___37239;
reagent.impl.template.oset(jsprops,"key",key_37241);
}
...
var G__37121 = reagent.impl.template.__GT_NativeWrapper();
(G__37121["name"] = c);
...
var G__37122 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [reagent.impl.template.reagent_input(),argv,comp,jsprops,first_child], null),cljs.core.meta(argv));
return (reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1(G__37122) : reagent.impl.template.as_element.call(null,G__37122));
} else {
...
while(true){
if((i__4731__auto___37253 < len__4730__auto___37251)){
args__4736__auto__.push((arguments[i__4731__auto___37253]));

var G__37255 = (i__4731__auto___37253 + (1));
i__4731__auto___37253 = G__37255;
continue;
} else {
}
break;
...
/** @this {Function} */
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq37127){
var G__37128 = cljs.core.first(seq37127);
var seq37127__$1 = cljs.core.next(seq37127);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__37128,seq37127__$1);
});
...
break;
default:
var G__37260 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
v = G__37260;
continue;
...
var n__4607__auto___37261 = a.length;
var i_37262 = (0);
while(true){
if((i_37262 < n__4607__auto___37261)){
(a[i_37262] = reagent.impl.template.as_element((a[i_37262])));

var G__37263 = (i_37262 + (1));
i_37262 = G__37263;
continue;
} else {
}
...
var a = cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(s);
var n__4607__auto___37266 = a.length;
var i_37267 = (0);
while(true){
if((i_37267 < n__4607__auto___37266)){
var val_37268 = (a[i_37267]);
if(((cljs.core.vector_QMARK_(val_37268)) && ((reagent.impl.template.key_from_vec(val_37268) == null)))){
(o["no-key"] = true);
} else {
}

(a[i_37267] = reagent.impl.template.as_element(val_37268));

var G__37269 = (i_37267 + (1));
i_37267 = G__37269;
continue;
} else {
}
...
var ctx = ({});
var vec__37140 = reagent.ratom.check_derefs(((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev(x,ctx);
});})(ctx))
);
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37140,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37140,(1),null);
...
var G__37146 = (cljs.core.count(argv) - first_child);
switch (G__37146) {
case (0):
...
case (1):
var G__37147 = comp;
var G__37148 = jsprops;
var G__37149 = reagent.impl.template.as_element(cljs.core.nth.cljs$core$IFn$_invoke$arity$3(argv,first_child,null));
return module$node_modules$react$index.createElement(G__37147,G__37148,G__37149);

break;
default:
return module$node_modules$react$index.createElement.apply(null,cljs.core.reduce_kv(((function (G__37146){
